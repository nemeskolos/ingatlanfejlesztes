...
<div class="row">
  ...
  <div class="col">
    ...
    <div class="card" style="width: 18rem;">
      ...
      @elseif(($advertisementValue->rooms == 2 && $advertisementValue->price < 12500000)) <img src="http://127.0.0.1:8000/asd2cheap.jpg" class="card-img-top" alt="...">
        ...
        @elseif(($advertisementValue->rooms == 3 && $advertisementValue->price < 15000000)) <img src="http://127.0.0.1:8000/asd3cheap.jpg" class="card-img-top" alt="...">
